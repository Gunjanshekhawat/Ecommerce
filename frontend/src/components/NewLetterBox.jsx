...
function NewLetterBox() {
  ...
  return (
    <div className='w-[100vw] h-[40vh] bg-gradient-to-l from-[#141414] to-[#0c2025] fles items-center justify-center gap-[10px] flex-col'>
        <p className='md:text-[30px] text-[20px] text-[#a5faf7] text-center font-semibold px-[20px]'>Subscribe Now & get 20% off</p>
        ...
        <form action="" className='w-[100%] h-[30%] mid:h-[50%] flex items-center justify-center mt-[20px] gap-[20px] px-[20px]' onSubmit={handleSubmit}>
