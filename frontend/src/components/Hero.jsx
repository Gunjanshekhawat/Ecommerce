...
function Hero({HeroCount,HeroData,setHeroCount}) {
  return (
    <div className='w-[40%] h-[100%] relative'>
           <div className='absolute text-[#8849ee] text-[20px] md:text-[40px] lg:text-[55px] md:left-[10%] md:top-[90px] lg:top-[130px] left-[10%] top-[10px]'>
                <p>{HeroData.text1}</p>
                <p>{HeroData.text2}</p>
           </div>
