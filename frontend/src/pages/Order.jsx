...
function Order() {
    ...
    const loadOrderData=async()=>{
      try {
        const result=await axios.post(url+'/api/order/userorder',{},{withCredentials:true})
        ...
        <div className='w-[100%] h-[92%] flex flex-wrap gap-[20px]'>
          {
               orderData.map((item,index)=>{
                 return <div className='w-[100%] h-[10%] border-t border-b' key={index}>
                   ...
                   <div className='flex items-start justify-center flex-col gap-[5px]'>
                    ...
                    <div className='absolute md:left-[55%] flex flex-row justify-start gap-[5px] items-center md:top-[40%] right-[2%] top-[20%]'>
